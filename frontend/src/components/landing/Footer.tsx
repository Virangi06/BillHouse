...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-navy text-white pt-8 pb-4 md:pt-20 md:pb-10 border-t border-white/5 relative z-10">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        
        {/* Footer Top */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-8 gap-x-6 md:gap-12 mb-6 md:mb-16">
          
          {/* Logo & Tagline column */}
          <div className="col-span-2 md:col-span-2 flex flex-col items-start text-left gap-4 md:gap-6">
            <Link to="/" onClick={handleScrollTop} className="flex items-center justify-start">
              <img 
                src={logo} 
                alt="BillHouse Logo" 
          ...
          <div className="col-span-1 flex flex-col items-start text-left gap-3 md:gap-4">
            <h4 className="text-xs font-bold uppercase tracking-wider text-green">Product</h4>
            <ul className="flex flex-col items-start gap-2.5 text-sm text-text-secondary">
        ...
        {/* Footer Bottom */}
        <div className="border-t border-white/5 pt-4 md:pt-8 text-center text-xs text-text-secondary font-medium">
